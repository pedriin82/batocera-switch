         ...
         ####################################################################
            u=/userdata/system/switch/extra/batocera-switch-desktopupdater.sh
               rm "$u" 2>/dev/null
                  ...
                  echo "  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O /tmp/.batocera-switch-updater40.sh https://raw.githubusercontent.com/pedriin82/batocera-switch/main/system/switch/extra/batocera-switch-updater40.sh" >> "$u"
                  ##echo "  curl -sSf https://raw.githubusercontent.com/pedriin82/batocera-switch/main/system/switch/extra/batocera-switch-updater40.sh -o /tmp/.batocera-switch-updater40.sh " >> "$u"
...
# /userdata/system/switch/extra/ryujinx/ will keep all ryujinx related dependencies
		  ...
		  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/extra/extralibr.zip" "https://github.com/pedriin82/batocera-switch/raw/main/system/switch/extra/extralibr.zip"
...
url_es_features_switch=https://raw.githubusercontent.com/pedriin82/batocera-switch/refs/heads/main/system/switch/configgen40/emulationstation40/es_features_switch.cfg
url_es_systems_switch=https://raw.githubusercontent.com/pedriin82/batocera-switch/refs/heads/main/system/switch/configgen40/emulationstation40/es_systems_switch.cfg
...
url_updater=https://raw.githubusercontent.com/pedriin82/batocera-switch/main/system/switch/extra/batocera-switch-updater40.sh
url_portsupdater=https://raw.githubusercontent.com/pedriin82/batocera-switch/main/roms/ports/Switch%20Updater40.sh
url_portsupdaterkeys=https://raw.githubusercontent.com/pedriin82/batocera-switch/main/roms/ports/Switch%20Updater40.sh.keys   
...
url=https://raw.githubusercontent.com/pedriin82/batocera-switch/main/system/switch/configgen40
...
url=https://raw.githubusercontent.com/pedriin82/batocera-switch/main/system/switch/configgen40/generators
mkdir -p $path 2>/dev/null
...
url=https://raw.githubusercontent.com/pedriin82/batocera-switch/main/system/switch/configgen40/generators/yuzu
mkdir -p $path 2>/dev/null
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$path/__init__.py" "$url/__init__.py"
##curl -sSf "$url/__init__.py" -o "$path/__init__.py"
...
url=https://raw.githubusercontent.com/pedriin82/batocera-switch/main/system/switch/configgen40/generators/ryujinx
mkdir -p $path 2>/dev/null
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$path/__init__.py" "$url/__init__.py"
##curl -sSf "$url/__init__.py" -o "$path/__init__.py"
...
urldir="https://raw.githubusercontent.com/pedriin82/batocera-switch/main/system/switch/extra"
icon1url="http://raw.githubusercontent.com/pedriin82/batocera-switch/main/system/switch/extra/icon_updater.png"
icon2url="http://raw.githubusercontent.com/pedriin82/batocera-switch/main/system/switch/extra/icon_loading.png"
