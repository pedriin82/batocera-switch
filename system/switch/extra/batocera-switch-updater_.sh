         ...
         ####################################################################
            u=/userdata/system/switch/extra/batocera-switch-desktopupdater.sh
               rm "$u" 2>/dev/null
                  ...
                  echo "  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O /tmp/.batocera-switch-updater.sh https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/batocera-switch-updater.sh" >> "$u"
                  ##echo "  curl -sSf https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/batocera-switch-updater.sh -o /tmp/.batocera-switch-updater.sh " >> "$u"
...
EMULATORS="$(echo $EMULATORS | sed 's/ /-/g')"
   ...
   if [[ ! -f $cfg ]]; then 
      link_defaultconfig=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/batocera-switch-config.txt
...
if [[ "$MODE" = "DISPLAY" ]] || [[ "$MODE" = "display" ]]; then 
   ...
   url_loader=https://github.com/pedriin82/batocera-switch-uureel/raw/main/system/switch/extra/loader.mp4
...
#link_ryujinx=https://github.com/pedriin82/batocera.pro-uureel/raw/main/switch/extra/ryujinx-1.1.382-linux_x64.tar.gz
#link_ryujinxavalonia=https://github.com/pedriin82/batocera.pro-uureel/raw/main/switch/extra/test-ava-ryujinx-1.1.382-linux_x64.tar.gz
...
cd $temp/$emu
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$extra/$emu/xdg-mime" "https://github.com/pedriin82/batocera.pro-uureel/raw/main/switch/extra/xdg-mime"
###curl -sSf "https://github.com/pedriin82/batocera.pro-uureel/raw/main/switch/extra/xdg-mime" -o "$extra/$emu/xdg-mime"
...
# -------------------------------------------------------------------
# RYUJINXLDN:
#link_ryujinxldn=https://github.com/pedriin82/batocera.pro-uureel/raw/main/switch/extra/ava-ryujinx-1.1.0-ldn3.0.1-linux_x64.tar.gz
#link_ryujinxldn=https://github.com/pedriin82/batocera.pro-uureel/raw/main/switch/extra/ryujinx-1.1.0-ldn3.0.1-linux_x64.tar.gz
link_ryujinxldn=https://github.com/pedriin82/batocera.pro-uureel/raw/main/switch/extra/ryujinx-1.1.0-ldn3.1.3-linux_x64.tar.gz
## -------------------------------------------------------------------
# RYUJINXAVALONIA:
link_ryujinxavalonia=https://github.com/Ryujinx/release-channel-master/releases/download/$release_ryujinx/test-ava-ryujinx-$release_ryujinx-linux_x64.tar.gz
#
...
# ------------------------------------------------------------------- 
   extraurl="https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra"
# ------------------------------------------------------------------- 
...
#   wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/configgen/mapping.csv" "https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/configgen/mapping.csv"
...
# -------------------------------------------------------------------
# prepare patcher 
url_patcher="https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/batocera-switch-patcher.sh"
...
url_switchkeys=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/configs/evmapy/switch.keys
url_es_features_switch=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/configs/emulationstation/es_features_switch.cfg
url_es_systems_switch=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/configs/emulationstation/es_systems_switch.cfg
url_switchlauncher=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/configgen/switchlauncher.py
url_GeneratorImporter=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/configgen/GeneratorImporter.py
url_ryujinxMainlineGenerator=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/configgen/generators/ryujinx/ryujinxMainlineGenerator.py
url_yuzuMainlineGenerator=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/configgen/generators/yuzu/yuzuMainlineGenerator.py
url_sshupdater=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/batocera-switch-sshupdater.sh
url_updater=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/batocera-switch-updater.sh
url_portsupdater=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/roms/ports/Switch%20Updater.sh
url_portsupdaterkeys=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/roms/ports/Switch%20Updater.sh.keys   
...
url=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/configgen
...
url=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/configgen/generators
mkdir -p $path 2>/dev/null
...
url=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/configgen/generators/yuzu
mkdir -p $path 2>/dev/null
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$path/__init__.py" "$url/__init__.py"
##curl -sSf "$url/__init__.py" -o "$path/__init__.py"
...
url=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/configgen/generators/ryujinx
mkdir -p $path 2>/dev/null
wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$path/__init__.py" "$url/__init__.py"
##curl -sSf "$url/__init__.py" -o "$path/__init__.py"
...
# additional pass for folks who have issues connecting to github
   function get() {
      file="$1"
      path=/userdata/system/switch/configgen/sdl2
      url=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/configgen/sdl2
         mkdir -p $path 2>/dev/null
            if [[ ! -e "$path/$file" ]]; then
               cd $path
...
sdlurl=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/batocera-switch-libSDL2.so
   if [[ ! -e "$sdl" ]]; then 
...
urldir="https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra"
icon1url="http://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/icon_updater.png"
icon2url="http://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/icon_loading.png"
...
url=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/translations
mkdir -p $path 2>/dev/null
...
# GET TRANSLATOR
translator=https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/batocera-switch-translator.sh
...
# include display output: 
   ...
   mkdir /userdata/system/switch 2>/dev/null; mkdir /userdata/system/switch/extra 2>/dev/null
      if [[ ( -e "$tput" && "$(wc -c "$tput" | awk '{print $1}')" < "444" ) || ( ! -e "$tput" ) ]]; then
         rm "$tput" 2>/dev/null
         wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O /userdata/system/switch/extra/batocera-switch-tput https://github.com/pedriin82/batocera-switch-uureel/raw/main/system/switch/extra/batocera-switch-tput
         ##curl -sSf "https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/batocera-switch-tput" -o "/userdata/system/switch/extra/batocera-switch-tput"
      fi
      if [[ ( -e "$libtinfo" && "$(wc -c "$libtinfo" | awk '{print $1}')" < "444" ) || ( ! -e "$libtinfo" ) ]]; then
         rm "$libtinfo" 2>/dev/null
         wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O /userdata/system/switch/extra/batocera-switch-libtinfo.so.6 https://github.com/pedriin82/batocera-switch-uureel/raw/main/system/switch/extra/batocera-switch-libtinfo.so.6
         ##curl -sSf "https://raw.githubusercontent.com/pedriin82/batocera-switch-uureel/main/system/switch/extra/batocera-switch-libtinfo.so.6" -o "/userdata/system/switch/extra/batocera-switch-libtinfo.so.6"
      fi
